!(function (e, t) {
  ...
  function E(n, r) {
    function qa(e) {
      if (e || 0 === e) {
        ...
        (r || a._scrollers.cache !== qa.cacheID || i('ref')) &&
          ((qa.cacheID = a._scrollers.cache), (qa.v = n()));
  ...
  function H(e, t) {
    return (
      ((t && t._ctx && t._ctx.selector) || Me.utils.toArray)(e)[0] ||
  ...
  function M() {
    (Xe = Me.core.globals().ScrollTrigger) &&
      Xe.core &&
      (function _integrate() {
        var e = Xe.core,
          n = e.bridge || {},
    ...
    He = {
      ...
      sc: E(function (e) {
        return arguments.length
          ? Ae.scrollTo(e, Le.sc())
          : Ae.pageXOffset || De[n] || Ee[n] || Oe[n] || 0;
      }),
    },
    Le = {
      s: s,
      ...
      sc: E(function (e) {
        return arguments.length
          ? Ae.scrollTo(He.sc(), e)
          : Ae.pageYOffset || De[s] || Ee[s] || Oe[s] || 0;
      }),
    };
  (He.op = Le), (a._scrollers.cache = 0);
  var c =
    ((Observer.prototype.init = function init(e) {
      ...
      function qc(e, t) {
        return (
          ((ce.event = e) && u && ~u.indexOf(e.target)) ||
      ...
      function sc() {
        ...
        O && (n || r) && O(ce, e, t, _e, xe),
          ...
          r &&
            ...
            (le = ce.deltaY),
            (xe[0] = xe[1] = xe[2] = 0)),
          (re || ne) && (k && k(ce), ne && (v(ce), (ne = !1)), (re = !1)),
          ie && !(ie = !1) && $ && $(ce),
          oe && (G(ce), (oe = !1)),
          (ee = 0);
      }
      ...
      function uc(e, t) {
        Z &&
          !se &&
          ((ce.axis = se = Math.abs(e) > Math.abs(t) ? 'x' : 'y'), (ie = !0)),
          'y' !== se && ((_e[2] += e), ce._vx.update(e, !0)),
          'x' !== se && ((xe[2] += t), ce._vy.update(t, !0)),
          r ? (ee = ee || requestAnimationFrame(sc)) : sc();
      }
      function vc(e) {
        if (!qc(e, 1)) {
          ...
          (ce.x = t),
            (ce.y = n),
            (i ||
              Math.abs(ce.startX - t) >= s ||
              Math.abs(ce.startY - n) >= s) &&
              (v && (ne = !0),
              i || (ce.isDragging = !0),
              uc(r, o),
              i || (g && g(ce)));
      ...
      function Bc(e) {
        if (!qc(e)) {
          ...
          var t =
            ...
            f;
          tc(e.deltaX * t, e.deltaY * t, 0), a && !S && te.restart(!0);
        }
      }
      function Cc(e) {
        if (!qc(e)) {
        ...
        we = (ce.onRelease = function (t) {
          if (!qc(t, 1)) {
            ...
            var e = !isNaN(ce.y - ce.startY),
              ...
              r =
                n &&
                (3 < Math.abs(ce.x - ce.startX) ||
                  3 < Math.abs(ce.y - ce.startY)),
              o = K(t);
            !r &&
              e &&
              (ce._vx.reset(),
      ...
      (te = ce._dc =
        Me.delayedCall(l || 0.25, function onStopFunc() {
        ...
        (ce.enable = function (e) {
          return (
            ce.isEnabled ||
              ...
              ((0 <= t.indexOf('touch') && Ye) || 0 <= t.indexOf('pointer')) &&
                (z(i, Te[0], be, ue, U),
                z(ye, Te[2], we),
                z(ye, Te[3], we),
                Q && z(i, 'click', pc, !0, !0),
        ...
        (ce.disable = function () {
          ce.isEnabled &&
            ...
            ce.isPressed &&
              (ce._vx.reset(), ce._vy.reset(), A(S ? i : ye, Te[1], vc, !0)),
